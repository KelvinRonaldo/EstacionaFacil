...
public class CarregarListaMovimentos extends AsyncTask {
    ...
    public CarregarListaMovimentos(MainActivity context) {
...
//                    movimento.setValorPago(jsonMovimentos.getDouble("valorPago"));
    ...
    protected void onPostExecute(Object o) {
        ...
        MovimentacaoListAdapter movimentacaoListAdapter = new MovimentacaoListAdapter(context, movimentos);
        MainActivity.listaEstacionamento.setAdapter(movimentacaoListAdapter);
